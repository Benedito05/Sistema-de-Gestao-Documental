...
<head>
    <title>Funcionários | Sistema de Gestão Documental ZEE</title>
    <!-- start: META -->
    <meta charset="utf-8" />
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Funcionários <span class="text-bold">ZEE</span></h4>
                                ...
                                <div class="panel-body">
                                    <?php
                                    $resultado = mysqli_query($conecta, "select * from usuario order by 'id'");
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                        ...
                                        <tbody>
                                            ...
                                            while ($linhas = mysqli_fetch_array($resultado)) {
                                                echo "<tr>";
                                                echo "<td class=''>" . $a . "</td>";
                                                echo "<td class=''>" . $linhas['first_name'] . "</td>";
                                            ...
                                            ?>
                                                <td class="day past agileits w3layouts calendar-day-2015-11-01">
                                                    ...
                                                    <?php if (!isset($_SESSION['AdminId'])) { ?>
                                                        ...
                                                        <button type="button" title="editar funcionário" class="btn btn-warning view_data" id="<?php echo $linhas['id']; ?>"><i class="fa fa-edit"></i></button>


                                                    <?php } ?>
                                                    <?php if (!isset($_SESSION['AdminId'])) { ?>
                                                        <button type="button" title="eliminar funcionário" class="btn btn-danger view_datas" id="<?php echo $linhas['id']; ?>"><i class="fa fa-trash"></i></button>
                                                    <?php } ?>
                                                <?php
                                                echo "</tr>";
                                                $a++;
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <form method="POST" action="Validacao/update_funcionario.php">
                                ...
                                <div class="modal fade" id="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <form method="POST" action="Validacao/delete_funcionario.php">
                                            <div class="modal-content">

                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Eliminar Funcionário
                                                ...
                                                <div class="modal-body">
                                                    <p>Tem certeza que deseja eliminar funcionário?</p>
                                                    <p> <span id="dele_usuario"></span></p>
                                                </div>
        ...
        $(document).ready(function() {
            $(document).on('click', '.view_datas', function() {
                ...
                if (user_id !== '') {
                    ...
                    $.post('deletar_funcionario.php', dados, function(retorna) {
                        //Carregar o conteúdo para o usuário
                        $("#dele_usuario").html(retorna);
                        $('#static').modal('show');
                    });
