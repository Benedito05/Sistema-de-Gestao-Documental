...
<head>
	<title>Documentos Recebidos | Sistema de Gestão Documental ZEE</title>
	<!-- start: META -->
	<meta charset="utf-8" />
						...
						<div class="col-sm-12">
							<div class="tabbable">
								...
								<div class="tab-content">
									...
									<div id="panel_projects">

									<?php
										if (isset($_SESSION['apagar_documento'])) {
											echo $_SESSION['apagar_documento'];
											unset($_SESSION['apagar_documento']);
											echo "<script>
                                                    setTimeout(() => {
                                                        
                                                        window.location.replace('documentos_recebidos.php');
											...
											<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
												...
												<tbody>
													...
													while ($linhas = mysqli_fetch_array($resultado)) {
														echo "<tr>";
														echo "<td class=''>" . $a . "</td>";
														echo "<td ><span class ='fa fa-file-pdf-o fa-2x text-danger '></span></td>";
													
														// echo "<td class='fa fa-file-word-o fa-2x text-Warning '></td>";
														// echo "<td class='fa fa-file-excel-o fa-2x text-success '></td>";
														echo "<td class=''>" . $linhas['title'] . "</td>";
														// echo "<td class=''>" . $linhas['id_usuario_enviado'] . "</td>";
													...
													?>
														<td class="day past agileits w3layouts calendar-day-2015-11-01">
															...
															<?php } ?>
															<?php if (!isset($_SESSION['AdminId'])) { ?>
																<a href='Validacao/delete_document_receive.php?id_documento=<?php echo $linhas['id_documento']; ?>'><button type='button' title="Apagar Funcionário" class='btn  btn-danger'><i class="fa fa-trash"></i></button></a>
															<?php } ?>
														<?php
														echo "</tr>";
														$a++;
