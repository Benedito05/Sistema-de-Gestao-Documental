...
<head>
    <title> Enviar Documentos | Sistema de Gestão Documental ZEE</title>
    <!-- start: META -->
    <meta charset="utf-8">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Enviar <span class="text-bold">Documentos</span></h4>
                                ...
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <form enctype="multipart/form-data" class="form-horizontal" action="upload.php" method="POST">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                            <div class="btn btn-light-grey btn-file">
                                                                ...
                                                                <span class="fileupload-exists"><i class="fa fa-folder-open-o"></i> Mudar Arquivo</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" placeholder="Escreva o Título do documento" name="title" id="form-field-1" class="form-control" maxlength="50" required>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <select name="id_usuario_recebido[]" multiple="multiple" id="form-field-select-4" class="form-control search-select" data-placeholder="Click para seleccionar destinatário" style="width: 100%;" required>
                                                    <?php
                                                    $resultado = mysqli_query($conecta, "select * from usuario where  id != " . $_SESSION['UserId']);
                                                    ...
                                                    while ($linhas = mysqli_fetch_array($resultado)) {
                                                        ...
                                                        echo '<option ' . $selected . '  value="' . $linhas['id'] . '">' . $linhas['first_name'] . ' ' . $linhas['last_name'] . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <h5 class="space15" style="margin-left: 10px;">Nivel de Urgência </h5>
                                        <div class="radio" style="margin-left: 10px;">
                                            <label>
                                                <input type="radio" value="alta" name="status" class="red" required>
                                                Alta
                                            </label>
                                        </div>
                                        <div class="radio" style="margin-left: 10px;;" required>
                                            <label>
                                                <input type="radio" value="media" name="status" class="yellow">
                                                Média
                                            </label>
                                        </div>
                                        <div class="radio" style="margin-left: 10px;" required>
                                            <label>
                                                <input type="radio" value="baixa" name="status" class="green">
                                                Baixa
                                            </label>
                                        </div>

                                        <input type="hidden" name="id_usuario_enviado"></button>



                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                <label class="col-sm-5 col-lg-offset-5 control-label">
                                                    <input type="submit" value="Enviar Arquivo" class="btn btn-green  form-control" name="enviar">
                                                </label>
                                            </div>
