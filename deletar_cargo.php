...
if(isset($_POST["user_id"])){
	...
	$query_user = "SELECT * FROM funcao WHERE id = '" . $_POST["user_id"] . "' LIMIT 1";
	...
	$resultado .=  '<input type="text" name ="name" class="form- control col-lg-9"  readonly value="'.$row_user['name']. '" >';
