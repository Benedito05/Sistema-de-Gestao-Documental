...
<head>
	<title>Documentos Enviados | Sistema de Gestão Documental ZEE</title>
	<!-- start: META -->
	<meta charset="utf-8" />
										...
										if (isset($_SESSION['apagar_documento'])) {
											...
											echo "<script>
                                                    setTimeout(() => {
                                                        ...
                                                        window.location.replace('documentos_enviados.php');
											...
											<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
												...
												<tbody>
													...
													while ($linhas = mysqli_fetch_array($resultado)) {
														...
														// echo "<td class=''>" . $linhas['id_usuario_recebido'] . "</td>";
													...
													?>
														<td class="day past agileits w3layouts calendar-day-2015-11-01">
															...
															<?php } ?>
															<?php if (!isset($_SESSION['AdminId'])) { ?>
																<a href='Validacao/delete_document_send.php?id_documento=<?php echo $linhas['id_documento']; ?>'><button type='button' title="Apagar Documento Enviado" class='btn  btn-danger'><i class="fa fa-trash"></i></button></a>
															<?php } ?>
														<?php
														echo "</tr>";
														$a++;
