...
(function(t) {
    t.extend(t.fn, {
        ...
        messages: { required: "Este Campo é obrigatório.", remote: "Please fix this field.", email: "Por Favor Introduza um endereço de emai válido.", url: "Por Favor a uma URL válida.", date: "Please enter a valid date.", dateISO: "Por Favor envie uma data válida(ISO).", number: "Please enter a valid number.", digits: "Please enter only digits.", creditcard: "Please enter a valid credit card number.", equalTo: "Valores  introduzidos DiferentesVerifique novamente ambos ", maxlength: t.validator.format("Please enter no more than {0} characters."), minlength: t.validator.format("Por Favor Introduza um valor superior ou igual a {0} caracteres."), rangelength: t.validator.format("Por Favor Introduza um valor entre {0} e {1} caracter ."), range: t.validator.format("Please enter a value between {0} and {1}."), max: t.validator.format("Please enter a value less than or equal to {0}."), min: t.validator.format("Please enter a value greater than or equal to {0}.") },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
                function e(e) {
