var TableExport = function() {
    ...
    var runDataTable_example2 = function() {
        ...
        function saveRow(oTable, nRow) {
            ...
            oTable.fnUpdate('<a class="delete-row" href="">Eliminar</a>', nRow, 4, false);
            oTable.fnDraw();
            newRow = false;
...
$('#sample-table-2_colum_toggler input[type="checkbox"]').change(function() {
