    ...
    for($i = 0; $i < $numFile; $i++){
        ...
        if(move_uploaded_file($tmp, $folder.'/'.$novoNome)){
           ...
           //$msg[] = "<b>$name : </b> Upload Realizado com Sucesso";
            ...
            $query = mysqli_query($conecta, "INSERT INTO usuario (first_name, last_name, genre, email, password, level, foto) VALUES ('$first_name', '$last_name', '$genre', '$email', '$password', '$level', '$file'.$i)");

             $sql = 'INSERT INTO usuario (first_name, last_name, genre,email,password,level, foto)';
            $sql.= 'VALUES (:first_name, :last_name, :genre, :email, :password, :level, :foto)';
            ...
            try {
                ...
                $create->bindValue(':level', $level, PDO::PARAM_STR);
