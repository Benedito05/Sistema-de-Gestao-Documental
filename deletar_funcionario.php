...
if(isset($_POST["user_id"])){
	...
	$resultado .=  '<input type="text" name ="first_name" class="form- control col-lg-9"  readonly value="'.$row_user['first_name']. '" >';
	
	$resultado .= '<label class="col-sm-3">Sobrenome:</label>';
	$resultado .= '<input type="text" name="last_name" class="form- control col-lg-9" value="'.$row_user['last_name'].'"  readonly>';
	
	$resultado .= '<label class="col-sm-3">Email:</label>';
	$resultado .= '<input type="text" name="email" class="form- control col-lg-9" value="'.$row_user['email'].'"  readonly>';
		
    $resultado .= '<label class="col-sm-3">Nivel de Acesso:</label>';
	$resultado .= '<input type="text" name="Nivel_Acesso" class="form- control col-lg-9" value="'.$row_user['Nivel_Acesso'].'"  readonly>';
	$resultado .= '</div>';
